...
Download the
http://downloads.sourceforge.net/project/log4cplus/log4cplus-stable/2.0.0/log4cplus-2.0.0-rc2.tar.xz[source code].
Extract the content to `{BUILD_DIR}`, then proceed with the following commands:

==== On Linux

[source,sh,subs="attributes+"]
$ cd {BUILD_DIR}/log4cplus-2.0.0-rc2
...
[source,sh]
$ cd C:\nutpp\output\log4cplus-2.0.0-rc2\msvc10
